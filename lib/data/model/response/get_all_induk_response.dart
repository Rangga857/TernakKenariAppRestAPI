...
class GetAllIndukResponse {
  ...
  factory GetAllIndukResponse.fromRawJson(String str) =>
      GetAllIndukResponse.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory GetAllIndukResponse.fromJson(Map<String, dynamic> json) =>
      GetAllIndukResponse(
        message: json["message"],
        statusCode: json["status_code"],
